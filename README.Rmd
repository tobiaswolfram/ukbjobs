...
In this package, we provide a collection of helpful external information on occupations that can be merged to UKB via SOC2000. While currently focused on occupational status, the set of available resources will be extended over time.
